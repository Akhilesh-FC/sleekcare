            ...
            <div class="container">
                <header>
                    <div class="logoo">
                        ...
                        <p>Hospital Name: <span>' . $row["hospital_name"] . '</span></p>
                    </div>
                    <div class="clinic">
                        <h2></h2>
                    </div>
