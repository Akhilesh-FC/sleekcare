...
@section('admin')
	...
	{{-- <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
		...
		<a href="javascript:void(0)" class="btn btn-outline-primary"><i class="las la-cog scale5 me-3"></i>Customize Layout</a>
	</div> --}}
	<div class="row">
		<div class="col-xl-3 col-sm-6">
			<div class="card">
				...
				<div class="progress  rounded-0" style="height:4px;">
					<div class="progress-bar rounded-0 bg-secondary progress-animated" style="width: 0%; height:4px;" role="progressbar">
	...
	<div class="row">
							...
							<div class="tab-content">
									...
									<div class="d-flex flex-wrap align-items-center px-4 bg-light">
										<div class="me-auto d-flex align-items-center py-3">
											...
											<div>
												...
												<span class="fs-26 text-primary font-w600">0</span>
											</div>
										</div>
									...
									<div class="row align-items-center">
										...
										<div class="col-xl-6 col-xxl-12 col-md-6">
											<div class="d-flex mb-4 align-items-center">
												<span class="me-auto ps-3 font-w500 fs-30 text-black">
													<svg class="me-3" width="8" height="30" viewBox="0 0 8 30" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<div class="tab-pane fade" id="Weekly" role="tabpanel">
									<div class="d-flex flex-wrap align-items-center px-4  bg-light">
										...
										{{-- <ul class="users ps-3 py-2">
											<li><img src="public/images/users/2.png" alt=""></li>
											<li><img src="public/images/users/4.png" alt=""></li>
											<li><img src="public/images/users/1.png" alt=""></li>
											<li><img src="public/images/users/4.png" alt=""></li>
											<li><img src="public/images/users/3.png" alt=""></li>
										</ul> --}}
									</div>
									<div class="row align-items-center">
										<div class="col-xl-6 col-xxl-12 col-md-6">
					...
					<div class="card">
						...
						<div class="card-body pb-0">
							<ul class="users-sm mb-3">
								<li><img src="public/images/users/6.png" alt=""></li>
								<li><img src="public/images/users/7.png" alt=""></li>
								<li><img src="public/images/users/8.png" alt=""></li>
								<li><img src="public/images/users/9.png" alt=""></li>
								<li><img src="public/images/users/10.png" alt=""></li>
							</ul>
							<div class="d-flex align-items-center">
								<svg class="me-3" width="30" height="19" viewBox="0 0 30 19" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="card-body">
							<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
								<div class="d-flex align-items-center me-auto ps-2">
									...
									<img src="public/images/users/1.jpg" class="img-1 me-sm-4 me-3" alt="">
									<div>
							...
							<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
								<div class="d-flex align-items-center me-auto ps-2">
									...
									<img src="public/images/users/2.jpg" class="img-1 me-sm-4 me-3" alt="">
									<div>
							...
							<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
								<div class="d-flex align-items-center me-auto ps-2">
									...
									<img src="public/images/users/3.jpg" class="img-1 me-sm-4 me-3" alt="">
									<div>
							...
							<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
								<div class="d-flex align-items-center me-auto ps-2">
									...
									<img src="public/images/users/4.jpg" class="img-1 me-sm-4 me-3" alt="">
									<div>
							...
							<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
								<div class="d-flex align-items-center me-auto ps-2">
									...
									<img src="public/images/users/5.jpg" class="img-1 me-sm-4 me-3" alt="">
									<div>
				...
				<div class="col-xl-12">	
					<div class="card patient-activity">
								...
								<table class="table table-responsive-sm">
									<tbody>
										<tr>
											<td>
												<div class="d-flex">
													<img src="public/images/users/6.jpg" alt="" class="img-2 me-3">
													<div>
										...
										<tr>
											<td>
												<div class="d-flex">
													<img src="public/images/users/7.jpg" alt="" class="img-2 me-3">
													<div>
										...
										<tr>
											<td>
												<div class="d-flex">
													<img src="public/images/users/8.jpg" alt="" class="img-2 me-3">
													<div>
										...
										<tr>
											<td>
												<div class="d-flex">
													<img src="public/images/users/9.jpg" alt="" class="img-2 me-3">
													<div>
										...
										<tr>
											<td>
												<div class="d-flex">
													<img src="public/images/users/10.jpg" alt="" class="img-2 me-3">
													<div>
										...
										<tr>
											<td>
												<div class="d-flex">
													<img src="public/images/users/11.jpg" alt="" class="img-2 me-3">
													<div>
						...
						<div class="card-footer text-center border-0">
							<a href="patient.html" class="btn-link text-primary">See More >></a>
						</div>
					</div>
				</div>
			</div>
        ...
        ***********************************-->
        <div class="footer">
    <div class="copyright">
        <p>Copyright © Designed &amp; Developed by <a href="" target="_blank">Founder code</a> 2023</p>
    </div>
</div>        <!--**********************************
            Footer end
        ***********************************-->
