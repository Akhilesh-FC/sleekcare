          ...
          <table class="table align-items-center table-flush table-hover mb-5" id="example" >
            ...
            <tbody id="myTable" class="text-white">
             ...
             <tr>
                ...
                <td> <a href="p_appointment?id={{$item->id}}" type="button" class="btn btn-info">{{$item->total_appointments}}</a></td>
                <td>
                    <a href="/patient/edit/{{$item->id}}" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i></a>
                </td>
             </tr>
             @endforeach
            </tbody>
